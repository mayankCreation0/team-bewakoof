var cartData = JSON.parse(localStorage.getItem("cart"))||[];
     ...
     // var youMayLikeData=JSON.parse(localStorage.getItem("mayLike"))||[];
     ...
     var totalS = cartData.reduce(function(sum,el,i,arr){
...
function triBeFun()
{
     ...
     cartData.map(function(el,i,arr)
     {
         ...
         strikeOffPrice1.setAttribute("class","strikPrice");
          ...
          btnS.innerText="Size: s";
          var btnQ=document.createElement("button");
          btnQ.innerText="Qty: 1";
          SQ.append(btnS,btnQ);
        ...
        btnQ.setAttribute("id","btnQ");
         ...
         mainBtn.setAttribute("id","mainBtn")
          ...
          document.querySelector("#itemData").append(box);
          ...
          btnR.addEventListener("click",function(el,i,arr){
           removeItem(el,i)
     });
